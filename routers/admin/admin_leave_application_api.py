...
from schema.leave_application_schema import LeaveApplicationResponse, LeaveApplicationStatusUpdate
from routers.auth import db_dependency, user_dependency
from common.common import _require_admin
from common.leave_application import (
    get_application_by_id_admin, get_all_by_employee_admin,
...
def put_leave_status(app_id: int, update: LeaveApplicationStatusUpdate, db: db_dependency, user: user_dependency):
    _require_admin(user)
