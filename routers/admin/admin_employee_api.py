...
def retrieve_employee_by_id_endpoint(
...
def retrieve_employee_by_email_endpoint(
...
def register_employee_endpoint(
    employee: EmployeeCreate, db: db_dependency, user: user_dependency
):
...
def remove_employee_by_id_endpoint(
    employee_id: int, db: db_dependency, user: user_dependency
):
...
def remove_employee_by_email_endpoint(
    email: str, db: db_dependency, user: user_dependency
):
