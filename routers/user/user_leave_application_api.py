...
from common.leave_application import (
    ...
    get_my_applications_by_status,
    get_my_application_by_id,
    get_my_applications_by_month,
)
...
@router.post(
    "/", response_model=LeaveApplicationResponse, status_code=status.HTTP_201_CREATED
)
def create_leave_application_endpoint(
    app_in: LeaveApplicationCreate, db: db_dependency, user: user_dependency
):
