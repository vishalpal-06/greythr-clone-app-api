...
from common.expense_claim import (
    ...
    get_my_claims_by_status,
    get_my_claim_by_id,
    get_my_claims_by_month,
)
...
@router.post(
    "/", response_model=ExpenseClaimResponse, status_code=status.HTTP_201_CREATED
)
def create_expense(
    claim_in: ExpenseClaimCreate, db: db_dependency, user: user_dependency
):
