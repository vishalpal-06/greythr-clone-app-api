...
BASE_PATH = (
    Path(__file__).resolve().parent.parent.parent / "expected_responses/user/salary/"
)
...
# -------------------------------------------------Test Admin API ---------------------------------------------------
def test_user_admin_access_get_employee_salary_by_years_forbidden(client, user_A1):
    response = client.get(
...
def test_user_admin_access_get_salary_by_empid_forbidden(client, user_A1):
    response = client.get(
        "admin/salaries/employee/1/year/2026",
        headers={"Authorization": f"Bearer {user_A1}"},
    )
...
def test_user_admin_access_post_salary_forbidden(client, user_A1):
...
def test_user_admin_access_delete_salary_by_salaryid_forbidden(client, user_A1):
    response = client.delete(
