...
def test_user_delete_others_leave_application_by_id_forbidden(
...
def test_user_delete_leave_application_not_exist_by_id_not_found(
    client, user_A1, read_json
):
    response = client.delete(
...
def test_user_get_my_leave_application_not_exist_by_id_not_found(
    client, user_A1, read_json
):
    response = client.get(
...
def test_user_get_my_leave_application_by_year_and_month_success(
    client, user_A1, read_json
):
    response = client.get(
...
def test_user_get_my_leave_application_by_year_and_month_not_found(
    client, user_A1, read_json
):
    response = client.get(
...
def test_user_manager_access_get_leave_applications_by_status_success(
    client, user_A1, read_json
):
    response = client.get(
