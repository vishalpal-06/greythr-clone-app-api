...
# -----------------------------------Test User API -----------------------------------
def test_user_create_my_leave_application_success(client, user_A1, read_json):
    payload = {
    ...
    expected = read_json(
        "expected_responses/user/leave_applications/create_my_leave_application_userA1.json"
    )
    assert response.status_code == 201
    assert response.json() == expected


def test_user_delete_my_leave_application_by_id_success(client, user_A1, read_json):
...
def test_user_delete_others_leave_application_by_id_forbidden(client, user_A1, read_json):
    response = client.delete(
...
def test_user_delete_leave_application_not_exist_by_id_not_found(client, user_A1, read_json):
    response = client.delete(
...
def test_user_get_my_leave_application_by_id_success(client, user_A1, read_json):
    response = client.get(
        "/user/my/leave-applications/1", headers={"Authorization": f"Bearer {user_A1}"}
    )
    expected = read_json(
        "expected_responses/user/leave_applications/get_my_leave_application_by_id_userA1.json"
    )
    assert response.status_code == 200
    assert response.json() == expected


def test_user_get_others_leave_application_by_id_forbidden(client, user_A1, read_json):
    response = client.get(
...
def test_user_get_my_leave_application_not_exist_by_id_not_found(client, user_A1, read_json):
    response = client.get(
...
def test_user_get_my_leave_application_by_status_success(client, user_A1, read_json):
    response = client.get(
        "/user/my/leave-applications/status/Pending",
        headers={"Authorization": f"Bearer {user_A1}"},
    )
    expected = read_json(
        "expected_responses/user/leave_applications/get_my_leave_application_by_status_userA1.json"
    )
    assert response.status_code == 200
    assert response.json() == expected


def test_user_get_my_leave_application_by_year_and_month_success(client, user_A1, read_json):
    response = client.get(
        "/user/my/leave-applications/month/2025/6",
        headers={"Authorization": f"Bearer {user_A1}"},
    )
    expected = read_json(
        "expected_responses/user/leave_applications/get_my_leave_application_by_year_and_month_userA1.json"
    )
    assert response.status_code == 200
    assert response.json() == expected


def test_user_get_my_leave_application_by_year_and_month_not_found(client, user_A1, read_json):
    response = client.get(
...
def test_user_manager_access_get_leave_applications_by_status_success(client, user_A1, read_json):
    response = client.get(
...
def test_user_admin_access_leave_application_forbidden(
    client,
    user_A1,
    method,
    url,
