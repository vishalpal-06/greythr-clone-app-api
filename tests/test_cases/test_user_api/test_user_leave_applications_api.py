...
# -------------------------------------------------test user api ---------------------------------------------------
def test_user_create_leave_application_success(client, user_A1):
    payload = {
    ...
    expected = read_json("create_leave_application_userA1.json")
    assert response.status_code == 201
    assert response.json() == expected


def test_user_delete_own_leave_application_by_id_success(client, user_A1):
...
def test_user_get_my_leave_application_by_id_success(client, user_A1):
    ...
    expected = read_json("get_leave_application_by_id_userA1.json")
...
def test_user_get_leave_application_not_exist_by_id_not_found(client, user_A1):
    response = client.get(
...
def test_user_get_my_leave_application_by_status_success(client, user_A1):
    ...
    expected = read_json("get_leave_application_by_status_userA1.json")
    assert response.status_code == 200
    assert response.json() == expected
...
def test_user_get_my_leave_application_by_year_and_month_success(client, user_A1):
    ...
    expected = read_json("get_leave_application_by_year_and_month_userA1.json")
    assert response.status_code == 200
    assert response.json() == expected
...
# -------------------------------------------------test manager api ---------------------------------------------------
def test_user_access_manager_update_leave_application_status_by_id_forbidden(client, user_A1):
    response = client.put(
...
def test_user_access_manager_update_leave_application_not_exist_status_by_id_not_found(client, user_A1):
    response = client.put(
...
def test_user_access_manager_get_leave_applications_by_status_success(client, user_A1):
    response = client.get(
...
def test_user_access_manager_get_leave_applications_by_year_and_month_success(client, user_A1):
    response = client.get(
...
def test_user_access_manager_leave_applications_by_empid_not_under_manager_forbidden(client, user_A1):
    response = client.get(
...
def test_user_access_manager_leave_applications_by_empid_not_exist_not_found(client, user_A1):
    response = client.get(
...
# -------------------------------------------------test admin api ---------------------------------------------------
def test_user_access_admin_get_employee_leave_application_by_id_forbidden(client, user_A1):
    response = client.get(
...
def test_user_access_admin_get_employee_leave_application_by_empid_forbidden(client, user_A1):
    response = client.get(
...
def test_user_access_admin_get_employee_leave_application_by_year_and_month_forbidden(client, user_A1):
    response = client.get(
...
def test_user_access_admin_update_employee_leave_application_status_by_id_forbidden(client, user_A1):
    response = client.put(
