...
def test_user_create_my_expense_claim_success(client, user_A1, read_json):
    ...
    expected = read_json("expected_responses/user/expense_claim/create_expense_userA1.json")
...
def test_user_delete_my_expense_claim_rejected_or_approved_fails(client, user_A1, read_json):
    response = client.delete(
...
def test_user_get_my_expense_claim_by_id_success(client, user_A1, read_json):
    ...
    expected = read_json("expected_responses/user/expense_claim/get_my_expense_by_id_userA1.json")
...
def test_user_get_expense_claims_by_status_success(client, user_A1, read_json):
    ...
    expected = read_json("expected_responses/user/expense_claim/get_expense_by_status_userA1.json")
    assert response.status_code == 200
    assert response.json() == expected
...
def test_user_update_subordinate_expense_claim_status_by_id_not_found(client, user_A1, read_json):
    response = client.put(
