...
# -------------------------------------------------test user api ---------------------------------------------------
def test_user_create_my_expense_claim_success(client, user_A1):
...
def test_user_delete_my_expense_claim_success(client, user_A1):
...
def test_user_delete_my_expense_claim_rejected_or_approved_fails(client, user_A1):
    response = client.delete(
...
def test_user_get_my_expense_claim_by_id_success(client, user_A1):
    response = client.get(
        "/user/my/expense-claims/5",
        headers={"Authorization": f"Bearer {user_A1}"},
    )
    expected = read_json("get_my_expense_by_id_userA1.json")
...
def test_user_get_expense_claims_by_status_success(client, user_A1):
    ...
    expected = read_json("get_expense_by_status_userA1.json")
    assert response.status_code == 200
    assert response.json() == expected
...
# -------------------------------------------------test manager api ---------------------------------------------------
def test_user_manager_access_get_subordinate_expense_claim_by_id_forbidden(client, user_A1):
    response = client.get(
...
def test_user_manager_access_get_subordinate_expense_claims_by_year_and_month_empty(client, user_A1):
    response = client.get(
...
def test_user_manager_access_get_subordinate_expense_claims_by_status_empty(client, user_A1):
    response = client.get(
...
def test_user_manager_access_get_subordinate_expense_claims_by_empid_year_month_nonsubordinate(client, user_A1):
    response = client.get(
...
def test_user_update_subordinate_expense_claim_status_nonsubordinate_forbidden(client, user_A1):
    response = client.put(
...
def test_user_update_subordinate_expense_claim_status_by_id_not_found(client, user_A1):
    response = client.put(
...
# -------------------------------------------------test admin api ---------------------------------------------------
def test_user_admin_access_get_employee_expense_claim_by_id_forbidden(client, user_A1):
    response = client.get(
...
def test_user_admin_access_get_employee_expense_claims_by_empid_year_month_forbidden(client, user_A1):
    response = client.get(
...
def test_user_update_employee_expense_claim_status_by_id_forbidden(client, user_A1):
    response = client.put(
