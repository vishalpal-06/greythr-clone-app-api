...
# -------------------------------------------------test admin api ---------------------------------------------------
def test_admin_access_admin_get_all_employees_forbidden(client, admin_user):
    response = client.get(
        "/admin/employees/",
        headers={"Authorization": f"Bearer {admin_user}"}
    )
...
def test_admin_access_admin_create_employee_forbidden(client, admin_user):
    payload = {
        "first_name": "string",
        "last_name": "string",
...
# def test_admin_access_admin_get_employee_by_id_forbidden(client, admin_user):
#     response = client.get(
...
# def test_admin_access_admin_update_employee_by_id_forbidden(client, admin_user):
#     payload = {
#         "first_name": "string",
#         "last_name": "string",
#         "joining_date": "2025-11-27",
...
# def test_admin_access_admin_delete_employee_by_id_forbidden(client, admin_user):
...
# def test_admin_access_admin_get_employee_by_email_forbidden(client, admin_user):
#     response = client.get(
...
# def test_admin_access_admin_update_employee_by_email_forbidden(client, admin_user):
#     payload = {
#         "first_name": "string",
#         "last_name": "string",
#         "joining_date": "2025-11-27",
...
# def test_admin_access_admin_delete_employee_by_email_forbidden(client, admin_user):
#     response = client.delete(
#         "/admin/employees/email/admin@test.com",
#         headers={"Authorization": f"Bearer {admin_user}"}
#     )
