...
BASE_PATH = Path(__file__).resolve().parent.parent.parent / "expected_responses/admin/salary/"
...
def test_admin_admin_access_create_salary_conflict(client, admin_user):
    ...
    assert response.json() == {"detail":"Salary record already exists for employee 1 in year 2025"}
