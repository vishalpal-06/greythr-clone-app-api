...
def test_admin_get_all_departments_success(client, admin_user, read_json):
    ...
    expected = read_json("expected_responses/admin/departments/user_get_all_departments.json")
...
def test_admin_get_department_by_id_success(client, admin_user, read_json):
    ...
    expected = read_json("expected_responses/admin/departments/user_get_sales_department.json")
...
def test_admin_access_admin_update_department_by_id_success(client, admin_user, read_json):
    response = client.put(
...
def test_admin_access_admin_update_department_by_id_conflict(client, admin_user, read_json):
    response = client.put(
        "/admin/departments/id/1",
...
def test_admin_access_admin_update_department_by_id_not_found(client, admin_user, read_json):
    response = client.put(
...
def test_admin_access_admin_delete_department_by_id_success(client, admin_user, read_json):
...
def test_admin_access_admin_delete_department_by_id_not_found(client, admin_user, read_json):
    response = client.delete(
...
def test_admin_access_admin_update_department_by_name_success(client, admin_user, read_json):
    response = client.put(
...
def test_admin_access_admin_update_department_by_name_conflict(client, admin_user, read_json):
    response = client.put(
        "/admin/departments/name/Human Resources",
        params={"new_name": "Engineering"},
        headers={"Authorization": f"Bearer {admin_user}"},
...
def test_admin_access_admin_update_department_by_name_not_found(client, admin_user, read_json):
    response = client.put(
...
def test_admin_access_admin_delete_department_by_name_success(client, admin_user, read_json):
    response = client.delete(
        "/admin/departments/name/Human Resources",
        headers={"Authorization": f"Bearer {admin_user}"},
    )
...
def test_admin_access_admin_delete_department_by_name_forbidden(client, admin_user, read_json):
    response = client.delete(
        "/admin/departments/name/Faltu Department",
        headers={"Authorization": f"Bearer {admin_user}"},
    )
