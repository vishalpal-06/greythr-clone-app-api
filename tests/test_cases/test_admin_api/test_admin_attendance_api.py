...
def test_admin_get_all_my_attendance_success(client, admin_user, read_json):
    response = client.get(
...
def test_admin_get_my_attendance_by_date_success(client, admin_user, read_json):
    response = client.get(
        "/user/my/attendance/my/date/2023-01-01",
        headers={"Authorization": f"Bearer {admin_user}"},
    )
    expected = read_json(
        "expected_responses/admin/attendance/get_all_my_attendance_by_date_admin.json"
    )
    assert response.status_code == 200
    assert response.json() == expected


def test_admin_get_my_attendance_by_date_not_found(client, admin_user, read_json):
    response = client.get(
...
def test_admin_access_manager_attendance_by_date_success(client, admin_user, read_json):
    ...
    expected = read_json(
        "expected_responses/admin/attendance/get_all_attendenace_by_date_admin.json"
    )
    assert response.status_code == 200
    assert response.json() == expected
...
def test_admin_access_manager_attendance_by_employee_and_date_under_manager_success(
    client, admin_user, read_json
):
    response = client.get(
    ...
    expected = read_json(
        "expected_responses/admin/attendance/get_attendance_by_employee_and_date_admin.json"
    )
    assert response.status_code == 200
    assert response.json() == expected


def test_admin_access_manager_attendance_by_employee_and_date_not_under_manager_empty(
    client, admin_user
):
    response = client.get(
...
def test_admin_access_admin_attendance_by_date_success(client, admin_user, read_json):
    response = client.get(
...
def test_admin_access_admin_attendance_by_date_not_found(client, admin_user, read_json):
    response = client.get(
...
def test_admin_access_admin_attendance_by_empid_date_success(
    ...
    expected = read_json(
        "expected_responses/admin/attendance/get_attendance_by_empid_and_date_admin.json"
    )
    assert response.status_code == 200
    assert response.json() == expected
...
def test_admin_access_admin_attendance_by_empid_success(client, admin_user, read_json):
    response = client.get(
