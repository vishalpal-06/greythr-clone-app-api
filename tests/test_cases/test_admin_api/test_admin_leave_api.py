...
BASE_PATH = Path(__file__).resolve().parent.parent.parent / "expected_responses/admin/leave/"
...
def test_admin_manager_access_get_subordinates_leave_by_empid_and_year_success(client, admin_user):
    response = client.get(
...
def test_admin_manager_access_get_subordinates_leave_by_empid_and_year_nonsubordinate(client, admin_user):
    response = client.get(
...
def test_admin_manager_access_get_subordinate_leave_by_empid_success(client, admin_user):
    response = client.get(
        "manager/leaves/employee/2",
        headers={"Authorization": f"Bearer {admin_user}"}
    )
...
# -------------------------------------------------Test Admin API ---------------------------------------------------
def test_admin_admin_access_get_employee_leave_by_empid_and_years_success(client, admin_user):
    response = client.get(
