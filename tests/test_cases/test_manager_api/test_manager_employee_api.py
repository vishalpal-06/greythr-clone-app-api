...
def test_manager_get_my_profile_success(client, manager_A, read_json):
    ...
    expected = read_json(
        "expected_responses/manager/employee/get_my_details_manager_A.json"
    )
...
# -------------------------------------------------Test Manager API ---------------------------------------------------
def test_manager_manager_access_get_subordinate_by_id_success(
...
def test_manager_manager_access_get_subordinate_by_id_nonsubordinate(
    client, manager_A, read_json
):
    response = client.get(
...
def test_manager_manager_access_get_subordinate_by_email_success(
    client, manager_A, read_json
):
    response = client.get(
...
def test_manager_manager_access_get_subordinate_by_email_not_found(
    client, manager_A, read_json
):
    response = client.get(
...
def test_manager_manager_access_get_subordinate_by_id_not_found(
    client, manager_A, read_json
):
    response = client.get(
...
def test_manager_admin_access_get_employee_by_id_forbidden(
    client, manager_A, read_json
):
    response = client.get(
...
def test_manager_admin_access_update_employee_by_id_forbidden(
    client, manager_A, read_json
):
    payload = {
        "first_name": "string",
...
def test_manager_admin_access_delete_employee_by_id_forbidden(
    client, manager_A, read_json
):
...
def test_manager_admin_access_get_employee_by_email_forbidden(
    client, manager_A, read_json
):
    response = client.get(
...
def test_manager_admin_access_update_employee_by_email_forbidden(
    client, manager_A, read_json
):
    payload = {
        "first_name": "string",
...
def test_manager_admin_access_delete_employee_by_email_forbidden(
    client, manager_A, read_json
):
    response = client.delete(
        "/admin/employees/email/admin@test.com",
