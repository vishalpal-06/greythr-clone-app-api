...
# -------------------------------------------------test admin api ---------------------------------------------------
def test_manager_access_admin_create_department_forbidden(client, manager_A):
    payload = {
...
def test_manager_access_admin_update_department_by_id_forbidden(client, manager_A):
    response = client.put(
...
def test_manager_access_admin_delete_department_by_id_forbidden(client, manager_A):
...
def test_manager_access_admin_update_department_by_name_forbidden(client, manager_A):
    response = client.put(
...
def test_manager_access_admin_delete_department_by_name_forbidden(client, manager_A):
    response = client.delete(
        "/admin/departments/name/Human Resources",
        headers={"Authorization": f"Bearer {manager_A}"}
    )
